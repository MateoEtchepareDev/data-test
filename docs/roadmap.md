...
- [x] `js/mapa.js` + `data/geo/provincias.json`: mapa por provincia (Leaflet), destaca la provincia con mayor volumen, click en provincia con datos muestra sus ventas en la leyenda; provincias sin datos no son clicables (`pointer-events: none`).
